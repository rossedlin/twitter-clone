      ...
      ***REMOVED***
          <div className="col-12 mt-5">
            ...
            <p className="text-info">
              My purpose is to demonstrate building a <a href="https://firebase.google.com/"
                                                        target="_blank">firebase</a> / <a href="https://reactjs.org/"
                                                                                          target="_blank">react</a> app that emulates twitter.
            </p>
            <p className="text-info">
            ...
            <p className="text-info">
              ...
              you can check my <a href="https://github.com/rossedlin/twitter-clone" target="_blank">source code</a> here if you don't trust me.<br/>
            </p>
      ***REMOVED***
          <div className="col-12 mt-5">
